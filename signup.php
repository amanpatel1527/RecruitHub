...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>RecruitHub | Sign Up</title>
  ...
  <header>
            <nav>
                    <div class="icon"><a href="index.php">RecruitHub</a></div>
            </nav>
    </header>
    <div class="container">
      <div class="content">
        <h2>Make Part of RecruitHub</h2>
        <p><b>RecruitHub</b> will never post content to your social pages.</p>
      </div>
